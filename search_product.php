...
<!-- Second child -->
<nav class="navbar navbar-expand-lg alert alert-success"style="background-color: #7B68EE;">
<div class="text-center" style="display: flex; justify-content: center; align-items: center;">
    <!-- Your content goes here -->
    <!--<h2 style="text-align: center; color: yellow;">Explore Our Inventory for Your Match</h2>-->
</div>
        ...
        <ul class="navbar-nav font-weight-bold text-center">
            <?php 
                if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item'>
                            <h2 style='color: yellow; class='nav-link' href='#'> Hello, ".$_SESSION['username']." ready to find your perfect match? We’ve got some amazing options waiting just for you 😊</h2>
                          </li>";
                }
