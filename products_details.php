...
<div class="text-center">
    ...
    <h3 style="text-align: center; color: yellow;">Your Shopping Journey Isn't Over Yet: See More Now</h3>
</div>
        ...
        <ul class="navbar-nav font-weight-bold text-center">
            <?php 
                if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item'>
                            <h3 style='color: yellow;><a class='nav-link' href='#'>Dive into the endless options we offer, ".$_SESSION['username']."</a></h3>
                          </li>";
                }
