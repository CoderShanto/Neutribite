...
<div class="container-fluid p-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success" style="background-color:rgb(23, 42, 51) !important; 
    padding: 2px 12px; height:40px; margin: 0px  0 0; overflow: hidden;">
...
<!-- second child -->
<nav class="navbar navbar-expand-lg alert" style="background-color:rgb(255, 255, 255); height: 40px; padding: 5px 0;">
...
if(!isset($_SESSION['username'])){
  ...
  echo "<li class='nav-item'>
  <a class='nav-link' href='#'><h1 class='welcome font-weight-bold' style='color:black'>Welcome To Our Nutrition World ".$_SESSION['username']."</h1></a>
</li>";
}
