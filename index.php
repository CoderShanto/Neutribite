...
.services-title::after {
  ...
  width: 80px;
  height: 4px;
  background-color: #28a745; /* A green shade for a health-focused theme */
  position: absolute;
  bottom: -8px;
  left: 0;
  border-radius: 2px;
...
.services-point:hover {
  transform: translateY(-5px);
  background-color: #eafff0; /* Light green hover effect */
}
...
.services-button {
  background-color: #28a745; /* Green color representing health and freshness */
...
<div class="text-center">
    ...
    <h3 class="text-" style="text-align: center;color: yellow;animation: slideIn 1.2s ease-in-out;
    @keyframes slideIn {
  0% {
    opacity: 0;
    transform: translateX(-20px);
        ...
        <ul class="navbar-nav font-weight-bold text-center">
            <?php 
                if(!isset($_SESSION['username'])){
                    ...
                    echo "<li class='nav-item'>
                            <h3 style='color: yellow;><a class='nav-link' href='#'>Welcome ".$_SESSION['username']."</a></h3>
                          </li>";
                }
...
<div class="services-section">
  <div class="services-content">
    ...
    <p class="services-text">
      At NutritionBite, we make healthy eating simple and accessible. From personalized meal planning to a wide selection of nutritious meals, 
      we bring fresh and wholesome food right to your doorstep. Discover the joy of eating well with our curated services tailored to meet your needs.
    </p>
  ...
  <div class="services-image">
    <img src="./images/service.jpg" alt="Our Services Image">
  </div>
</div>
